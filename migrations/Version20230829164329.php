 ...
 */
final class Version20230829164329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adverts (id INT AUTO_INCREMENT NOT NULL, fk_pets_type_id INT NOT NULL, fk_company_id INT NOT NULL, status_id INT NOT NULL, title VARCHAR(255) NOT NULL, short_description LONGTEXT NOT NULL, description LONGTEXT NOT NULL, lof TINYINT(1) NOT NULL, lof_number INT DEFAULT NULL, lof_identifier INT DEFAULT NULL, lof_father_name VARCHAR(75) DEFAULT NULL, lof_father_identifier INT DEFAULT NULL, lof_mother_name VARCHAR(75) DEFAULT NULL, lof_mother_identifier INT DEFAULT NULL, name VARCHAR(75) DEFAULT NULL, birth_date DATE DEFAULT NULL, identified TINYINT(1) NOT NULL, vaccinated TINYINT(1) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, is_pro TINYINT(1) NOT NULL, visits SMALLINT NOT NULL, INDEX IDX_8C88E777BD6B178D (fk_pets_type_id), INDEX IDX_8C88E77767F5D045 (fk_company_id), INDEX IDX_8C88E7776BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, fk_team_id INT DEFAULT NULL, fk_user_id INT DEFAULT NULL, status_id INT NOT NULL, title VARCHAR(255) NOT NULL, short_description LONGTEXT NOT NULL, content LONGTEXT NOT NULL, date_add DATE NOT NULL, visits INT NOT NULL, meta_name VARCHAR(255) DEFAULT NULL, meta_description VARCHAR(255) DEFAULT NULL, meta_keywords VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, logo VARCHAR(255) DEFAULT NULL, INDEX IDX_BFDD3168D943E582 (fk_team_id), INDEX IDX_BFDD31685741EEB9 (fk_user_id), INDEX IDX_BFDD31686BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
