...
class AppFixtures extends Fixture
{
    ...
    public function transactionalFixtures($manager): void
    {
        ...
        (2, 'Email envoyé lors de la création d\'un compte admin', 'admin_password_create', 'Création de votre compte administrateur sur Légion', '<p>Bonjour {{ team.firstname }}, Ton compte administrateur vient d\'&ecirc;tre cr&eacute;&eacute; sur L&eacute;gion ! Il ne te reste plus qu\'&agrave; suivre ce lien pour cr&eacute;er ton mot de passe : <a href=\"{{ app.request.schemeAndHttpHost }}/reset-password/reset/{{ resetToken.token }}\">Cr&eacute;er mon mot de passe</a></p>\r\n<div>\r\n<div>Attention, ce lien n\'est valide que durant 1 heure</div>\r\n</div>'),
        (3, 'Mail envoyé pour la réinitialisation du mot de passe (users et admins)', 'reset_password', 'Réinitialisation de votre mot de passe', '<p>Bonjour, vous avez demand&eacute; la r&eacute;initialisation de votre mot de passe. Suivez le len ci-dessous afin de le r&eacute;initialiser <a href=\"{{ app.request.schemeAndHttpHost }}/reset-password/reset/{{ resetToken.token }}\">R&eacute;initialiser mon mot de passe</a> Attention, ce lien n\'est valide que durant {{ resetToken.expirationMessageKey }} heure</p>'),
        ...
        (10, 'Mail envoyé aux utilisateurs créés par un admin client', 'company_team_user_create', 'Votre compte a été créé sur Légion', '<p>Bonjour {{ user.firstname }},</p>\r\n<p>Ton compte vient d\'&ecirc;tre cr&eacute;&eacute; sur L&eacute;gion par l\'administrateur de &nbsp;{{ company.name }} !</p>\r\n<p>Il ne te reste plus qu\'&agrave; suivre ce lien pour cr&eacute;er ton mot de passe : <a href=\"{{ app.request.schemeAndHttpHost }}/reset-password/reset/{{ resetToken.token }}\">Cr&eacute;er mon mot de passe</a></p>\r\n<div>\r\n<div>Attention, ce lien n\'est valide que durant {{ resetToken.expirationMessageKey }}</div>\r\n</div>'),
        (11, 'Mail envoyé lors de la création d\'un compte utilisateur par un administrateur', 'user_password_create', 'Bienvenue sur Légion !', '<p>Bonjour {{ user.firstname }},</p>\r\n<p>Ton compte vient d\'&ecirc;tre cr&eacute;&eacute; sur L&eacute;gion !</p>\r\n<p>Il ne te reste plus qu\'&agrave; suivre ce lien pour cr&eacute;er ton mot de passe : <a href=\"{{ app.request.schemeAndHttpHost }}/reset-password/reset/{{ resetToken.token }}\">Cr&eacute;er mon mot de passe</a></p>\r\n<div>\r\n<div>Attention, ce lien n\'est valide que durant {{ resetToken.expirationMessageKey }}</div>\r\n</div>');
        ";
