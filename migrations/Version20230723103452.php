...
final class Version20230723103452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, fk_company_type_id INT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(80) NOT NULL, phone VARCHAR(25) DEFAULT NULL, address VARCHAR(255) NOT NULL, additional_address VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(15) NOT NULL, town VARCHAR(80) NOT NULL, status TINYINT(1) NOT NULL, longitude DOUBLE PRECISION DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, INDEX IDX_4FBF094F3CBDC271 (fk_company_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
